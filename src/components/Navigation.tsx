...
//           {/* LOGO + BUSINESS NAME (VISIBLE ON MOBILE) */}
//           <a
//             href="#home"
//             onClick={(e) => {
//               e.preventDefault();
...
//           >
//             {/* Logo Circle */}
//             <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-primary flex items-center justify-center shrink-0">
//               <span className="text-primary-foreground font-heading text-lg sm:text-xl font-bold">
//                 JA
//               </span>
//             </div>

//             {/* Business Name - NOW VISIBLE IN MOBILE */}
//             <div className="leading-tight">
//               <h1 className="font-heading text-sm sm:text-lg font-semibold text-foreground">
//                 Jai Anjaniputra
//               </h1>
...
//               <SheetContent
//                 side="right"
//                 className="w-full sm:w-80 bg-background border-l border-primary/20"
//               >
//                 <div className="flex flex-col h-full pt-8">
...
import { BUSINESS_NAME, NAV_LINKS, WHATSAPP } from "@/lib/constants";
import { cn } from "@/lib/utils";
import logo from "@/assets/JAP-Gold.jpeg"; // ✅ IMPORT YOUR LOGO
